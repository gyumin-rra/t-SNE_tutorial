...
<p align="center"><img src="https://user-images.githubusercontent.com/112034941/195265268-754e005b-f781-4151-ab6c-0c99e1777848.png" height="100px" width="600px"></p>

그런데, 조금 이상하지 않으신가요? 실제로 모멘텀 경사하강법의 solution update 식을 보면 -$\eta*$(gradient)로 되어있는데, 지금 논문에서의 식은 덧셈으로 연결되어있습니다. 제 생각에는 gradient descent를 위한 gradient를 구할 때, 어차피 gradient를 빼줘야 함을 고려하여 gradient 식의 $(y_i-y_j)$ 부분이 원래는   
